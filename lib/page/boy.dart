...
class BoyPage extends StatefulWidget {
  const BoyPage({Key? key}) : super(key: key);
                            ...
                            Container(
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  height: 71,
                                  child: IconButton(
                                      icon: Image.asset(boyPhoto[index].image),
                                      onPressed: () {
                                        setState(() {
                                          itemIndex = index;
                                        });
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                boyPhoto[itemIndex].desc1,
                                style: Lora_Body_Semibold(),
                              ),
                              Text(
                                boyPhoto[itemIndex].desc2,
                                style: Inter(),
                              ),
                            ],
                          ),
